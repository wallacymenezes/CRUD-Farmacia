package com.generation.projetofarmacia.configuration;
    ...
    OpenAPI springProjetoFarmacialOpenAPI(){
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("API do Projeto de Backend Farmacia - Generation Brasil")
                        .version("v0.1.0")
                        .license(new License()
                ...
                .externalDocs(new ExternalDocumentation()
                        .description("Github")
                        .url("https://github.com/wallacymenezes/CRUD-Farmacia"));
    }
